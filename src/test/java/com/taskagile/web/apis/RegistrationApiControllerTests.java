...
public class RegistrationApiControllerTests {
  ...
  @Test
  public void register_existedUsername_shouldFailedAndReturn400() throws Exception {
  ...
  @Test
  public void register_existedEmailAddress_shouldFailedAndReturn400() throws Exception {
    RegistrationPayload payload = new RegistrationPayload();
    payload.setUsername("exist");
    payload.setEmailAddress("test@taskagile.com");
    payload.setPassword("MyPassword");
    ...
    mvc.perform(post("/api/registrations")
      ...
      .content(JsonUtils.toJson(payload)))
    .andExpect(status().is(400))
    .andExpect(jsonPath("$.message").value("EmailAddress already exists"));
  }
